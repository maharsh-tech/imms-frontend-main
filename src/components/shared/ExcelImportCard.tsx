...
const ExcelImportCard = ({
  ...
  return (
    <div className="bg-surface-container-lowest shadow rounded-lg p-6 border border-outline-variant">
      <div className="flex items-start justify-between gap-4 mb-4">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-primary bg-primary-fixed/30 rounded-md hover:bg-surface-container disabled:opacity-50"
        >
      ...
      <div
        ...
        onDrop={handleDrop}
        className="border-2 border-dashed border-outline-variant rounded-lg p-8 text-center hover:border-blue-400 transition-colors"
      >
        <Upload className="w-8 h-8 text-outline mx-auto mb-3" />
        <p className="text-sm text-on-surface-variant mb-3">Drag & drop .xlsx here, or</p>
        <button
          type="button"
      ...
      {result && (
        <div className="mt-4 bg-surface-container-low rounded-md p-4 border border-outline-variant">
