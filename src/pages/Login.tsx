...
const Login = () => {
  ...
  const error = errorKey ? ERROR_MESSAGES[errorKey] ?? 'Sign-in failed.' : ''
      ...
      <AuthCard>
        <div className="mb-xxl text-center">
          ...
          <p className="text-body-md text-on-surface-variant">
            Sign in to IMMS with your institutional Google account
          </p>
        </div>
        ...
        <button
          ...
          className="mt-md flex w-full items-center justify-center gap-3 rounded-lg border border-outline-variant bg-surface-container-lowest py-4 text-label-md font-semibold text-on-surface shadow-sm transition-all hover:bg-surface-container-low active:scale-[0.98]"
        ...
        <p className="mt-lg text-center text-label-sm text-on-surface-variant">
          Students: use <strong>@charusat.edu.in</strong> · Staff: use <strong>@charusat.ac.in</strong>
        </p>
